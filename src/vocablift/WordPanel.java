...
public class WordPanel extends JPanel implements Runnable {
		...
		public void paintComponent(Graphics g) {
		   ...
		   //animation must be added 
			...
			try{
                            BufferedImage img = ImageIO.read(new File(VocabLift.workingDirectory+"/vocablift/pictures/"+words[i].getWord()+".jpg"));
                            //BufferedImage img = ImageIO.read(new File("pictures/"+words[i].getWord()+".jpg"));
                            //BufferedImage img = ImageIO.read(VocabLift.class.getResourceAsStream("pictures/"+words[i].getWord()+".jpg"));
